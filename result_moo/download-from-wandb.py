...
# ablations
algo_template = "sample-and-select-c={c}-ag=neglogsumexp-l=du-b=32:8-o=sa;qed;vina-s=0"
for c in [-1, -0.8, -0.6, -0.4, -0.2, 0, 0.2, 0.4, 0.6, 0.8, 1]:
    algo_name = algo_template.format(c=c)
    all_algos.append(algo_name)

algo_template = "sample-and-select-c=worst-ag=neglogsumexp-l=du-b={n}:32-o=sa;qed;vina-s=0"
for n in [2, 4, 8, 16, 32]:
    algo_name = algo_template.format(n=n)
    all_algos.append(algo_name)
